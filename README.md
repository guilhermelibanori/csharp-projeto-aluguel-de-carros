...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/csharp-029-csharp-projeto-aluguel-de-carros.git`.
  ...
  - Agora crie uma branch à qual você vai submeter os `commits` do seu projeto.
    ...
    - Exemplo: `git checkout -b joaozinho-csharp-029-csharp-projeto-aluguel-de-carros`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-csharp-029-csharp-projeto-aluguel-de-carros`.

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/csharp-029-csharp-projeto-aluguel-de-carros/pulls).
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/csharp-029-csharp-projeto-aluguel-de-carros/pulls) e confira que o seu _Pull Request_ está criado.
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH29-CSHARP&template=betrybe/csharp-0x-projeto-aluguel-de-carros)
